...
class Testconnectors134027ViewSet(BaseConnectorViewSet):
    PASSWORD = settings.CONNECTOR_TESTCONNECTORS134027_PASSWORD
    USERNAME = settings.CONNECTOR_TESTCONNECTORS134027_USERNAME
    BASE_URL = "https://devstringx.com"
    AUTH_TYPE = "basic"
    IDENTIFIER = "CONNECTOR_TESTCONNECTORS134027"
